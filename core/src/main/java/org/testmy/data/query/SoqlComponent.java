...
public class SoqlComponent {
    ...
    public SoqlComponent(final String fieldName, final Object fieldValue) {
    ...
    public static SoqlComponent soqlComponent(final String fieldName, final Object fieldValue){
